...
public class PhoneFragment extends Fragment implements ContactsAdapter.ContactsViewHolder.OnItemClickedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recycler_view_phone);
    ...
    private void buildContacts() {
        ...
        for (int i = 0; i < 30; i++) {
            if (i % 2 != 0) {
                sortedContacts.add(new Contact("Name " + i, "6621456624" + i, true));
            }
        }
